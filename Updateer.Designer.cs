namespace Jubity2D_10__Engine
{
    ...
    "ty2D-10 Pre-Alpha 0.1.3\r\nNew version is ";
            ...
            this.label3.Text = "Please update to new version to avoid bugs \r\nand get new features";
            // 
            // button1
            // 
            ...
            this.button2.Location = new System.Drawing.Point(422, 195);
            ...
            this.Name = "Updateer";
            this.Text = "Jubity Editor Update Check";
            this.Load += new System.EventHandler(this.Updateer_Load);
